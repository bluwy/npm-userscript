...
Fix syntax highlighting contrast issues in dark mode by using the GitHub Dark theme.
`

export function runPre() {
  if (isValidPackagePage()) {
    // NOTE: Use CSS nesting to simplify readability. Style format is largely copied from GitHub Light css.
    addStyle(`
